...
import {
  generateShadowCustomerEmail,
  generateShadowCustomerName,
  generateShadowCustomerPassword
} from '../auth/generateShadowCustomer.js';
import { normalizeWalletAddress } from './normalizeWalletAddress.js';

export async function upsertWalletCustomer(walletAddress: string) {
