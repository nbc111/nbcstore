    ...
    try {
        ...
        await connection.query(`UPDATE nbc_wallet
          SET balance = $1,
              frozen_balance = $2,
              updated_at = NOW()
        WHERE wallet_id = $3`, [balanceAfter, nextFrozenBalance, wallet.wallet_id]);
        const walletTx = await insert('nbc_wallet_transaction')
            ...
            metadata: {
                ...
                tx_hash: (receipt === null || receipt === void 0 ? void 0 : receipt.hash) || tx.hash,
        ...
        WHERE withdrawal_id = $4`, [
            (receipt === null || receipt === void 0 ? void 0 : receipt.hash) || tx.hash,
