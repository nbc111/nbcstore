...
export default async function migrate(connection) {
    await execute(connection, `CREATE TABLE "nbc_wallet" (
    ...
    await execute(connection, `CREATE INDEX "IDX_NBC_WALLET_CUSTOMER_ID" ON "nbc_wallet" ("customer_id")`);
    await execute(connection, `CREATE TABLE "nbc_wallet_transaction" (
    ...
    await execute(connection, `CREATE INDEX "IDX_NBC_WALLET_TX_WALLET_ID" ON "nbc_wallet_transaction" ("wallet_id")`);
    await execute(connection, `CREATE INDEX "IDX_NBC_WALLET_TX_ORDER_ID" ON "nbc_wallet_transaction" ("order_id")`);
    await execute(connection, `CREATE TABLE "nbc_order_usage" (
    ...
    await execute(connection, `CREATE TABLE "nbc_exchange_rate" (
    ...
    await execute(connection, `CREATE TABLE "nbc_onchain_deposit" (
    ...
    await execute(connection, `CREATE INDEX "IDX_NBC_ONCHAIN_DEPOSIT_STATUS" ON "nbc_onchain_deposit" ("status")`);
    await execute(connection, `CREATE INDEX "IDX_NBC_ONCHAIN_DEPOSIT_WALLET" ON "nbc_onchain_deposit" ("wallet_id")`);
    await execute(connection, `CREATE TABLE "nbc_sync_state" (
