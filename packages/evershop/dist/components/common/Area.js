...
function Area(props) {
    ...
    const effectiveNoOuter = process.env.NODE_ENV === 'development' && debug ? false : noOuter;
    ...
    const color = process.env.NODE_ENV === 'development' && debug ? areaColor(id) : '';
    if (process.env.NODE_ENV === 'development' && debug && effectiveNoOuter !== true) {
        const existingStyle = areaWrapperProps.style || {};
        const existingClass = areaWrapperProps.className || '';
        areaWrapperProps = {
            ...areaWrapperProps,
    ...
    const renderedChildren = areaComponents.map((w, index)=>{
        ...
        const propKeys = componentId !== undefined ? propsMap[componentId] || [] : [];
        ...
        if (/*#__PURE__*/ React.isValidElement(C)) {
            rendered = /*#__PURE__*/ React.createElement(React.Fragment, {
                key: index
            }, C);
        } else if (typeof C === 'string') {
            rendered = /*#__PURE__*/ React.createElement(C, {
                key: index,
                ...componentProps
            });
    ...
    if (process.env.NODE_ENV === 'development' && debug) {
        return /*#__PURE__*/ React.createElement(WrapperComponent, areaWrapperProps, /*#__PURE__*/ React.createElement("span", {
    ...
    return /*#__PURE__*/ React.createElement(WrapperComponent, areaWrapperProps, renderedChildren);
}
Area.defaultProps = {
    className: undefined,
    coreComponents: [],
