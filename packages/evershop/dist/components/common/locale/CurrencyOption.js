...
function CurrencyOptions(props) {
    ...
    const options = [
        ...
        {
            value: 'AZM',
            text: 'Azerbaijani Manat (1993-2006)'
        },
        {
            value: 'BSD',
        ...
        {
            value: 'GQE',
            text: 'Equatorial Guinean Ekwele'
        },
        {
            value: 'ERN',
            text: 'Eritrean Nakfa'
        ...
        {
            value: 'VEF',
            text: 'Venezuelan Bolívar Fuerte'
        },
        {
            value: 'VND',
