...
function Sheet({ ...props }) {
    return /*#__PURE__*/ React.createElement(SheetPrimitive.Root, {
        "data-slot": "sheet",
        ...props
    });
}
function SheetTrigger({ ...props }) {
    return /*#__PURE__*/ React.createElement(SheetPrimitive.Trigger, {
        "data-slot": "sheet-trigger",
        ...props
    });
}
function SheetClose({ ...props }) {
    return /*#__PURE__*/ React.createElement(SheetPrimitive.Close, {
        "data-slot": "sheet-close",
        ...props
    });
}
function SheetPortal({ ...props }) {
    return /*#__PURE__*/ React.createElement(SheetPrimitive.Portal, {
        "data-slot": "sheet-portal",
        ...props
    });
}
function SheetOverlay({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(SheetPrimitive.Backdrop, {
...
function SheetContent({ className, children, side = 'right', showCloseButton = true, ...props }) {
    return /*#__PURE__*/ React.createElement(SheetPortal, null, /*#__PURE__*/ React.createElement(SheetOverlay, null), /*#__PURE__*/ React.createElement(SheetPrimitive.Popup, {
        ...
        ...props
    }, children, showCloseButton && /*#__PURE__*/ React.createElement(SheetPrimitive.Close, {
        "data-slot": "sheet-close",
