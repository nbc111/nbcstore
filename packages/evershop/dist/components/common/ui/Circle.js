...
const circleInnerVariants = cva('border-2 rounded-full block w-[1.125rem] h-[1.125rem] flex justify-center', {
    variants: {
        variant: {
...
const circleDotVariants = cva('block w-[40%] h-[40%] self-center rounded-full', {
    variants: {
        variant: {
...
export function Circle({ variant = 'default', className }) {
    return /*#__PURE__*/ React.createElement("span", {
        className: cn(circleVariants({
            variant
        }), className)
    }, /*#__PURE__*/ React.createElement("span", {
        className: circleInnerVariants({
            variant
        })
    }, /*#__PURE__*/ React.createElement("span", {
        className: circleDotVariants({
            variant
        })
    })));
}
