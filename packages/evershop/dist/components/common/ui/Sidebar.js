...
import { Sheet, SheetContent, SheetDescription, SheetHeader, SheetTitle } from '@components/common/ui/Sheet.js';
import { Skeleton } from '@components/common/ui/Skeleton.js';
import { Tooltip, TooltipContent, TooltipTrigger } from '@components/common/ui/Tooltip.js';
...
function SidebarTrigger({ className, onClick, ...props }) {
    ...
    return /*#__PURE__*/ React.createElement(Button, {
        ...
        ...props
    }, /*#__PURE__*/ React.createElement(PanelLeftIcon, null), /*#__PURE__*/ React.createElement("span", {
        className: "sr-only"
    }, "Toggle Sidebar"));
}
...
function SidebarContent({ className, ...props }) {
    return /*#__PURE__*/ React.createElement("div", {
        ...
        className: cn('no-scrollbar gap-2 flex min-h-0 flex-1 flex-col overflow-auto group-data-[collapsible=icon]:overflow-hidden', className),
        ...props
    });
}
...
function SidebarMenuButton({ render, isActive = false, variant = 'default', size = 'default', tooltip, className, ...props }) {
    ...
    return /*#__PURE__*/ React.createElement(Tooltip, null, comp, /*#__PURE__*/ React.createElement(TooltipContent, {
        side: "right",
        align: "center",
...
function SidebarMenuSkeleton({ className, showIcon = false, ...props }) {
    ...
    return /*#__PURE__*/ React.createElement("div", {
        ...
        ...props
    }, showIcon && /*#__PURE__*/ React.createElement(Skeleton, {
