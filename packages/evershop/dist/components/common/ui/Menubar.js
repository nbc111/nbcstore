...
function MenubarPortal({ ...props }) {
    return /*#__PURE__*/ React.createElement(DropdownMenuPortal, {
        "data-slot": "menubar-portal",
        ...props
    });
}
function MenubarTrigger({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(DropdownMenuTrigger, {
        "data-slot": "menubar-trigger",
        className: cn('hover:bg-muted aria-expanded:bg-muted rounded-sm px-2 py-1 text-sm font-medium flex items-center outline-hidden select-none', className),
        ...props
    });
}
...
function MenubarCheckboxItem({ className, children, checked, ...props }) {
    return /*#__PURE__*/ React.createElement(MenuPrimitive.CheckboxItem, {
        ...
        className: cn('focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground gap-2 rounded-md py-1.5 pr-2 pl-8 text-sm data-disabled:opacity-50 relative flex cursor-default items-center outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0', className),
        checked: checked,
        ...props
...
function MenubarRadioGroup({ ...props }) {
    return /*#__PURE__*/ React.createElement(DropdownMenuRadioGroup, {
...
function MenubarShortcut({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(DropdownMenuShortcut, {
...
function MenubarSubTrigger({ className, inset, ...props }) {
    return /*#__PURE__*/ React.createElement(DropdownMenuSubTrigger, {
...
function MenubarSubContent({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(DropdownMenuSubContent, {
