/* eslint-disable jsx-a11y/click-events-have-key-events */ import { Button } from '@components/common/ui/Button.js';
import { Input } from '@components/common/ui/Input.js';
import { Textarea } from '@components/common/ui/Textarea.js';
import { cn } from '@evershop/evershop/lib/util/cn';
import { cva } from 'class-variance-authority';
import * as React from 'react';
const InputGroup = /*#__PURE__*/ React.forwardRef(({ className, ...props }, ref)=>{
...
const InputGroupAddon = /*#__PURE__*/ React.forwardRef(({ className, align = 'inline-start', ...props }, ref)=>{
    return /*#__PURE__*/ React.createElement("div", {
        ref: ref,
        role: "group",
...
const InputGroupButton = /*#__PURE__*/ React.forwardRef(({ className, type = 'button', variant = 'ghost', size = 'xs', ...props }, ref)=>{
...
const InputGroupText = /*#__PURE__*/ React.forwardRef(({ className, ...props }, ref)=>{
...
const InputGroupInput = /*#__PURE__*/ React.forwardRef(({ className, ...props }, ref)=>{
...
const InputGroupTextarea = /*#__PURE__*/ React.forwardRef(({ className, ...props }, ref)=>{
