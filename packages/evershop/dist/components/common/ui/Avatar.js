...
function Avatar({ className, size = 'default', ...props }) {
    return /*#__PURE__*/ React.createElement(AvatarPrimitive.Root, {
        "data-slot": "avatar",
        "data-size": size,
...
function AvatarImage({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(AvatarPrimitive.Image, {
...
function AvatarFallback({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(AvatarPrimitive.Fallback, {
