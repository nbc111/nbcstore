...
function NavigationMenu({ className, children, ...props }) {
    return /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.Root, {
        "data-slot": "navigation-menu",
        className: cn('group/navigation-menu relative flex max-w-max flex-1 items-center justify-center', className),
        ...props
    }, children, /*#__PURE__*/ React.createElement(NavigationMenuPositioner, null));
}
function NavigationMenuList({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.List, {
...
function NavigationMenuItem({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.Item, {
...
function NavigationMenuTrigger({ className, children, ...props }) {
    return /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.Trigger, {
...
function NavigationMenuContent({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.Content, {
        "data-slot": "navigation-menu-content",
        className: cn('data-[motion^=from-]:animate-in data-[motion^=to-]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[motion=from-end]:slide-in-from-right-52 data-[motion=from-start]:slide-in-from-left-52 data-[motion=to-end]:slide-out-to-right-52 data-[motion=to-start]:slide-out-to-left-52 group-data-[viewport=false]/navigation-menu:bg-popover group-data-[viewport=false]/navigation-menu:text-popover-foreground group-data-[viewport=false]/navigation-menu:data-open:animate-in group-data-[viewport=false]/navigation-menu:data-closed:animate-out group-data-[viewport=false]/navigation-menu:data-closed:zoom-out-95 group-data-[viewport=false]/navigation-menu:data-open:zoom-in-95 group-data-[viewport=false]/navigation-menu:data-open:fade-in-0 group-data-[viewport=false]/navigation-menu:data-closed:fade-out-0 group-data-[viewport=false]/navigation-menu:ring-foreground/10 p-2 pr-2.5 ease-[cubic-bezier(0.22,1,0.36,1)] group-data-[viewport=false]/navigation-menu:rounded-md group-data-[viewport=false]/navigation-menu:shadow group-data-[viewport=false]/navigation-menu:ring-1 group-data-[viewport=false]/navigation-menu:duration-300 h-full w-auto **:data-[slot=navigation-menu-link]:focus:ring-0 **:data-[slot=navigation-menu-link]:focus:outline-none', className),
        ...props
    });
}
function NavigationMenuPositioner({ className, side = 'bottom', sideOffset = 8, align = 'start', alignOffset = 0, ...props }) {
    return /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.Portal, null, /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.Positioner, {
        side: side,
        sideOffset: sideOffset,
        align: align,
        alignOffset: alignOffset,
        className: cn('transition-[top,left,right,bottom] duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] data-[side=bottom]:before:-top-2.5 data-[side=bottom]:before:right-0 data-[side=bottom]:before:left-0 isolate z-50 h-(--positioner-height) w-(--positioner-width) max-w-(--available-width) data-instant:transition-none', className),
        ...props
    }, /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.Popup, {
    ...
    }, /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.Viewport, {
        className: "relative size-full overflow-hidden"
    }))));
}
function NavigationMenuLink({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.Link, {
...
function NavigationMenuIndicator({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(NavigationMenuPrimitive.Icon, {
