...
function Tabs({ className, orientation = 'horizontal', ...props }) {
    return /*#__PURE__*/ React.createElement(TabsPrimitive.Root, {
        "data-slot": "tabs",
...
function TabsTrigger({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(TabsPrimitive.Tab, {
...
function TabsContent({ className, ...props }) {
    return /*#__PURE__*/ React.createElement(TabsPrimitive.Panel, {
