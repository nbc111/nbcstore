import { generateToken, generateRefreshToken, verifyToken, verifyRefreshToken, decodeToken, TOKEN_TYPES } from '../../jwt.js';
...
describe('JWT Utility Functions', ()=>{
    ...
    beforeAll(()=>{
        ...
        process.env.JWT_ADMIN_REFRESH_SECRET = 'test-admin-refresh-secret-key-at-least-32-chars';
        ...
        process.env.JWT_CUSTOMER_SECRET = 'test-customer-secret-key-at-least-32-chars';
        process.env.JWT_CUSTOMER_REFRESH_SECRET = 'test-customer-refresh-secret-key-at-least-32-chars';
    ...
    describe('verifyRefreshToken', ()=>{
        ...
        it('should reject refresh token with wrong token type', ()=>{
            ...
            const adminRefreshToken = generateRefreshToken(payload, TOKEN_TYPES.ADMIN);
            expect(()=>{
    ...
    describe('Token Security', ()=>{
        ...
        it('should prevent token type confusion between admin and customer', ()=>{
            ...
            const customerToken = generateToken(customerPayload, TOKEN_TYPES.CUSTOMER);
    ...
    describe('Integration Tests', ()=>{
        it('should support full token refresh flow', ()=>{
            ...
            const decodedRefresh = verifyRefreshToken(refreshToken, TOKEN_TYPES.CUSTOMER);
            ...
            const decodedNewAccess = verifyToken(newAccessToken, TOKEN_TYPES.CUSTOMER);
        ...
        it('should handle admin login/refresh flow', ()=>{
            ...
            const verifiedRefresh = verifyRefreshToken(refreshToken, TOKEN_TYPES.ADMIN);
            const newAccessToken = generateToken({
    ...
    describe('Environment Configuration Tests', ()=>{
        ...
        afterAll(()=>{
            ...
            process.env.JWT_ADMIN_REFRESH_SECRET = originalEnv.JWT_ADMIN_REFRESH_SECRET;
            process.env.JWT_CUSTOMER_SECRET = originalEnv.JWT_CUSTOMER_SECRET;
            process.env.JWT_CUSTOMER_REFRESH_SECRET = originalEnv.JWT_CUSTOMER_REFRESH_SECRET;
        });
        ...
        describe('Missing All Secrets', ()=>{
            it('should fail gracefully when all secrets are missing', ()=>{
                ...
                expect(()=>generateToken(customerPayload, TOKEN_TYPES.CUSTOMER)).toThrow();
                expect(()=>generateRefreshToken(adminPayload, TOKEN_TYPES.ADMIN)).toThrow();
                expect(()=>generateRefreshToken(customerPayload, TOKEN_TYPES.CUSTOMER)).toThrow();
                // Restore all secrets
                process.env.JWT_ADMIN_SECRET = originalEnv.JWT_ADMIN_SECRET;
                process.env.JWT_ADMIN_REFRESH_SECRET = originalEnv.JWT_ADMIN_REFRESH_SECRET;
                process.env.JWT_CUSTOMER_SECRET = originalEnv.JWT_CUSTOMER_SECRET;
