import { injectPreloadLinks, injectPreloadLinksAfterCharset, cleanupPreloadAttributes, processPreloadImages } from '../../preloadScan.js';
...
<body>
  <img src="/test-image.jpg" srcSet="/test-image.jpg 500w, /test-image.jpg 1000w" sizes="100vw" alt="Test" itemProp="preload" />
            ...
            expect(result).toContain('<link rel="preload" as="image" href="/test-image.jpg" fetchpriority="high"');
            expect(result).toContain('imagesrcset="/test-image.jpg 500w, /test-image.jpg 1000w"');
...
<body>
  ...
  <img src="/normal-image.jpg" alt="Normal" />
            ...
            expect(result).toContain('<link rel="preload" as="image" href="/hero-image.jpg" fetchpriority="high"');
            expect(result).toContain('imagesrcset="/hero-image.jpg 500w, /hero-image.jpg 1000w"');
            expect(result).toContain('imagesizes="100vw"');
...
<body>
  ...
  />
            ...
            expect(result).toContain('imagesrcset="/complex-image.jpg 320w, /complex-image.jpg 640w, /complex-image.jpg 1024w"');
            expect(result).toContain('imagesizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"');
...
<body>
  <img src="/minimal.jpg" itemProp="preload" />
            ...
            const result = processPreloadImages(html);
            expect(result).toContain('<link rel="preload" as="image" href="/minimal.jpg" fetchpriority="high" />');
    ...
    describe('performance and scalability', ()=>{
        test('should handle large HTML documents efficiently', ()=>{
            ...
            const manyImages = Array.from({
                length: 100
            }, (_, i)=>`<img src="/image${i}.jpg" alt="Image ${i}" ${i % 10 === 0 ? 'itemProp="preload"' : ''} />`).join('\n');
            const html = `<!DOCTYPE html>
<html>
<head>
  <meta charSet="utf-8" />
