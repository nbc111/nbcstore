...
addProcessor('logger', ()=>{
    const config = getValueSync('logger_configuration', ()=>{
        ...
        const DEFAULT_CONFIG = {
            ...
            transports: isDebugging || !logFile ? [
                consoleTransport
            ] : [
            ...
            exceptionHandlers: isDebugging || !logFile ? [
                consoleTransport
            ] : [
                new winston.transports.File({
                    filename: logFile
