...
describe('Test removeCartItem', ()=>{
    ...
    it('Auto remove another item based on SKU', async ()=>{
        hookAfter('removeCartItem', async function removeAnotherItem(removedItem, cart) {
    ...
    it('Prevent removing an item based on SKU', async ()=>{
        hookBefore('removeCartItem', async function preventRemovingItem(cart, uuid, context) {
            const items = cart.getItems();
