...
describe('Test updateCartItemQty', ()=>{
    ...
    it('Auto add another item based on SKU', async ()=>{
        hookAfter('updateCartItemQty', async function addAnotherItem(updatedItem, cart, uuid, qty, action) {
    ...
    it('Prevent update an item qty based on SKU', async ()=>{
        hookBefore('updateCartItemQty', async function preventUpdatingItemQty(cart, uuid) {
            const items = cart.getItems();
