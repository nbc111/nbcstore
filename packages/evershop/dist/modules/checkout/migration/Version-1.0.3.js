...
export default (async (connection)=>{
    ...
    await execute(connection, `CREATE OR REPLACE FUNCTION add_order_created_event() RETURNS TRIGGER AS $$
    BEGIN
    ...
    await execute(connection, `CREATE TRIGGER "ADD_ORDER_CREATED_EVENT_TRIGGER"
