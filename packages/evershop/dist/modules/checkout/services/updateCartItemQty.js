...
export default (async (cart, uuid, qty, action, context = {})=>{
    const updatedItem = await hookable(updateCartItemQty, context)(cart, uuid, qty, action, context);
    return updatedItem;
});
export function hookBeforeUpdateCartItemQty(callback, priority = 10) {
    hookBefore('updateCartItemQty', callback, priority);
}
export function hookAfterUpdateCartItemQty(callback, priority = 10) {
