 ...
 */ export default (async (cart, productID, qty, context)=>{
    const item = await hookable(addCartItem, context)(cart, productID, qty, context);
    return item;
});
export function hookBeforeAddCartItem(callback, priority = 10) {
    hookBefore('addCartItem', callback, priority);
}
export function hookAfterAddCartItem(callback, priority = 10) {
