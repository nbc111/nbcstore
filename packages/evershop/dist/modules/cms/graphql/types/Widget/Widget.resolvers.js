...
export default {
    Query: {
        ...
        widgetTypes: ()=>{
            ...
            return types.map((row)=>({
                    ...
                    createWidgetUrl: buildUrl('widgetNew', {
                        type: row.type
                    })
                }));
        },
        ...
        slideshowWidget (_, { slides, autoplay, autoplaySpeed, arrows, dots, fullWidth, widthValue, heightValue, heightType }) {
            return {
                slides: slides || [],
    ...
    Widget: {
        editUrl: ({ uuid })=>buildUrl('widgetEdit', {
                id: uuid
            }),
        updateApi: (widget)=>buildUrl('updateWidget', {
                id: widget.uuid
            }),
        deleteApi: (widget)=>buildUrl('deleteWidget', {
                id: widget.uuid
            })
    }
};
