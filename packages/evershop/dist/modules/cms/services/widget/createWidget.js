...
import widgetDataSchema from './widgetDataSchema.json' with {
    type: 'json'
};
function validateWidgetDataBeforeInsert(data) {
    ...
    const jsonSchema = getValueSync('createWidgetDataJsonSchema', widgetDataSchema, {});
 ...
 */ async function createWidget(data, context) {
    ...
    try {
        ...
        // Insert widget data
        const widget = await hookable(insertWidgetData, {
            ...context,
            connection
...
export function hookBeforeInsertWidgetData(callback, priority = 10) {
    hookBefore('insertWidgetData', callback, priority);
}
export function hookAfterInsertWidgetData(callback, priority = 10) {
    hookAfter('insertWidgetData', callback, priority);
}
export function hookBeforeCreateWidget(callback, priority = 10) {
    hookBefore('createWidget', callback, priority);
}
export function hookAfterCreateWidget(callback, priority = 10) {
