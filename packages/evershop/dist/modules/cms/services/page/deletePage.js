 ...
 */ const _deletePage = async function deletePage(uuid, context) {
...
export async function deletePage(uuid, context) {
...
export function hookBeforeDeletePageData(callback, priority = 10) {
    hookBefore('deletePageData', callback, priority);
}
export function hookAfterDeletePageData(callback, priority = 10) {
    hookAfter('deletePageData', callback, priority);
}
export function hookBeforeDeletePage(callback, priority = 10) {
    hookBefore('deletePage', callback, priority);
}
export function hookAfterDeletePage(callback, priority = 10) {
