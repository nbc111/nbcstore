export function graphqlErrorMessageFormat(inputString, lineNumber, columnNumber) {
    if (!inputString) {
        return '';
    }
    ...
    const highlightedLine = line.replace(highlightedText, `${ANSI_HIGHLIGHT}${highlightedText}${ANSI_RESET}`);
