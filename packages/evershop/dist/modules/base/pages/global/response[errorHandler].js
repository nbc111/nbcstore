...
import { getPageMetaInfo, setPageMetaInfo } from '../../../../modules/cms/services/pageMetaInfo.js';
            ...
            if (response.$body && response.$body !== '') {
                ...
                setPageMetaInfo(request, {
                    route: {
                        ...
                        params: Object.fromEntries(Object.entries(request.params).map(([key, value])=>[
                                key,
                ...
                if (isDevelopmentMode() && request.query && request.query.fashRefresh === 'true' || request.query && request.query.ajax === 'true') {
