...
const TestCards = ({ showTestCard, testSuccess, testFailure })=>{
    return /*#__PURE__*/ React.createElement("div", null, /*#__PURE__*/ React.createElement("div", {
        ...
        className: "text-xs text-gray-600"
    }, "Test card expiry: 04/26"), /*#__PURE__*/ React.createElement("div", {
        className: "text-xs text-gray-600"
        ...
        className: "self-center flex space-x-2 pb-2"
    }, /*#__PURE__*/ React.createElement(Button, {
        onClick: testSuccess,
        title: "Test success",
        variant: "default"
    }, "Test success"), /*#__PURE__*/ React.createElement(Button, {
        onClick: testFailure,
        title: "Test failure",
        variant: "destructive"
    }, "Test failure"))));
};
export function CheckoutForm({ stripePublishableKey, createPaymentIntentApi, returnUrl }) {
    ...
    useEffect(()=>{
        const validateStripe = async ()=>{
            ...
            if (submit?.error) {
                toast.error(submit.error.message || _('Can not process payment. Please try again later.'));
                return false;
            }
            return true;
        };
    ...
    useEffect(()=>{
        if (orderId && orderPlaced && paymentMethod === 'stripe') {
            window.fetch(createPaymentIntentApi, {
                method: 'POST',
                headers: {
        ...
        const confirmPayment = async ()=>{
            const payload = await stripe?.confirmPayment({
                ...
                confirmParams: {
                    payment_method_data: {
                        billing_details: {
                            name: billingAddress?.fullName || shippingAddress?.fullName || customerFullName || '',
                            email: customerEmail,
                            phone: billingAddress?.telephone || shippingAddress?.telephone || '',
                            address: {
                                line1: billingAddress?.address1 || shippingAddress?.address1 || '',
                                country: billingAddress?.country?.code || shippingAddress?.country?.code || '',
                                state: billingAddress?.province?.code || shippingAddress?.province?.code || '',
    ...
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement(RenderIfTrue, {
        condition: !!(stripe && elements)
    }, /*#__PURE__*/ React.createElement("div", null, /*#__PURE__*/ React.createElement("div", {
        className: "stripe-form float-left w-full"
    }, stripePublishableKey && stripePublishableKey.startsWith('pk_test') && /*#__PURE__*/ React.createElement(TestCards, {
...
const StripeApp = /*#__PURE__*/ React.memo(({ total, currency, stripePublishableKey, returnUrl, createPaymentIntentApi, stripePaymentMode })=>{
    ...
    useEffect(()=>{
        registerPaymentComponent('stripe', {
            nameRenderer: ()=>/*#__PURE__*/ React.createElement("div", {
                ...
                }, /*#__PURE__*/ React.createElement("span", null, setting.stripeDisplayName), /*#__PURE__*/ React.createElement(Cards, {
                    width: 100
                })),
            formRenderer: ()=>/*#__PURE__*/ React.createElement(StripeApp, {
            ...
            checkoutButtonRenderer: ()=>{
                ...
                const handleClick = async (e)=>{
                    try {
                        e.preventDefault();
                        const validateStripe = window?.validateStripePayment;
                        if (validateStripe) {
                        ...
                        toast.error(error instanceof Error ? error.message : _('An unexpected error occurred. Please try again.'));
                    }
                };
                ...
                }, loadingStates.placingOrder ? /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement("svg", {
                ...
                })), /*#__PURE__*/ React.createElement("span", null, _('Processing Payment...'))) : orderPlaced ? /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement("svg", {
                    className: "w-5 h-5",
                    fill: "currentColor",
                    viewBox: "0 0 24 24"
                }, /*#__PURE__*/ React.createElement("path", {
                    d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"
                })), /*#__PURE__*/ React.createElement("span", null, _('Order Placed'))) : /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement("span", null, _('Pay with Stripe')), /*#__PURE__*/ React.createElement("svg", {
                    className: "w-5 h-5",
                    fill: "currentColor",
                    viewBox: "0 0 24 24"
                }, /*#__PURE__*/ React.createElement("path", {
