...
import { decodeToken, TOKEN_TYPES, verifyToken } from '../../../../lib/util/jwt.js';
export default ((request, response, next)=>{
    try {
        ...
        if (!decodedWithoutVerification || decodedWithoutVerification.tokenType !== TOKEN_TYPES.CUSTOMER) {
