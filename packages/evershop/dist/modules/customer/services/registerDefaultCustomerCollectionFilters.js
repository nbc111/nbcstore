    ...
    const defaultFilters = [
        {
            ...
            callback: (query, operation, value, currentFilters)=>{
                query.andWhere('customer.full_name', 'ILIKE', `%${value}%`).or('customer.email', 'ILIKE', `%${value}%`);
                currentFilters.push({
                    key: 'keyword',
                    operation,
                    value
        ...
        },
        {
            ...
            callback: (query, operation, value, currentFilters)=>{
                query.andWhere('customer.full_name', OPERATION_MAP[operation], `%${value}%`);
                currentFilters.push({
                    key: 'full_name',
                    operation,
                    value
        ...
        },
        {
            ...
            callback: (query, operation, value, currentFilters)=>{
                const customerCollectionSortBy = getValueSync('customerCollectionSortBy', {
