...
export const updateShipmentStatus = async (orderId, status, conn)=>{
    ...
    try {
        ...
        hookable(validateShipmentStatusBeforeUpdate, {
            orderId
        })(status);
...
export function hookBeforeValidateShipmentStatusBeforeUpdate(callback, priority = 10) {
    hookBefore('validateShipmentStatusBeforeUpdate', callback, priority);
}
export function hookAfterValidateShipmentStatusBeforeUpdate(callback, priority = 10) {
    hookAfter('validateShipmentStatusBeforeUpdate', callback, priority);
}
export function hookBeforeChangeShipmentStatus(callback, priority = 10) {
    hookBefore('changeShipmentStatus', callback, priority);
}
export function hookAfterChangeShipmentStatus(callback, priority = 10) {
