...
import { changeOrderStatus, resolveOrderStatus } from './services/updateOrderStatus.js';
...
export default (()=>{
    ...
    addProcessor('orderCollectionFilters', registerDefaultOrderCollectionFilters, 1);
    addProcessor('orderCollectionFilters', (filters)=>[
            ...filters,
            ...defaultPaginationFilters
        ], 2);
    hookAfter('changePaymentStatus', async (order, orderId, status, connection)=>{
    ...
    hookAfter('changeShipmentStatus', async (order, orderId, status, connection)=>{
    ...
    hookAfter('saveOrder', async function createShipmentForVirtualProductsOrder(order, cart, connection) {
