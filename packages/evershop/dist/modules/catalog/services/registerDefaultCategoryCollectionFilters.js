    ...
    const defaultFilters = [
        {
            ...
            callback: (query, operation, value, currentFilters)=>{
                query.andWhere('category_description.name', OPERATION_MAP[operation], `%${value}%`);
                currentFilters.push({
                    key: 'name',
                    operation,
                    value
        ...
        },
        {
            ...
            callback: (query, operation, value, currentFilters)=>{
                query.andWhere('category.include_in_nav', OPERATION_MAP[operation], value);
                currentFilters.push({
                    key: 'include_in_nav',
                    operation,
                    value
        ...
        },
        {
            ...
            callback: (query, operation, value, currentFilters)=>{
                const categorySortBy = getValueSync('categoryCollectionSortBy', {
