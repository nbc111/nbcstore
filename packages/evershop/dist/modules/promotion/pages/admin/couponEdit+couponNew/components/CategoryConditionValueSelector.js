...
export const CategoryConditionValueSelector = ({ selectedValues, updateCondition, isMulti })=>{
    ...
    }, /*#__PURE__*/ React.createElement(DialogHeader, null, /*#__PURE__*/ React.createElement(DialogTitle, null, _('Choose Categories'))), /*#__PURE__*/ React.createElement(CategorySelector, {
        onSelect: onSelect,
