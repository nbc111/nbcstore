...
export function registerCartPromotionFields(fields) {
    const newFields = fields.concat(/** Adding fields to the Cart object */ [
        {
            key: 'coupon',
            resolvers: [
            ...
            dependencies: [
                'items'
            ] // TODO: Add customer id and customer group id as a dependency
        },
        {
            key: 'discount_amount',
            resolvers: [
            ...
            resolvers: [
                async function resolver() {
                    ...
                    if (!priceIncludingTax) {
                        return toPrice(this.getData('sub_total') - this.getData('discount_amount'));
                    } else {
                        return toPrice(this.getData('sub_total_incl_tax') - this.getData('discount_amount') - this.getData('tax_amount'));
                    }
                }
            ],
            dependencies: [
        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    return toPrice(this.getData('sub_total_with_discount') + this.getData('tax_amount'));
                }
            ],
            dependencies: [
        ...
        },
        {
            ...
            resolvers: [
                async function resolver() {
                    return toPrice(this.getData('sub_total_with_discount_incl_tax') + this.getData('shipping_fee_incl_tax'));
                }
            ],
            dependencies: [
