...
export default (()=>{
    addProcessor('couponLoaderFunction', ()=>async (couponCode)=>{
    ...
    addProcessor('couponCollectionFilters', registerDefaultCouponCollectionFilters, 1);
    addProcessor('couponCollectionFilters', (filters)=>[
            ...filters,
