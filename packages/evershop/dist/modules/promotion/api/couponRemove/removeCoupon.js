...
export default (async (request, response, next)=>{
    try {
        const coupon = Array.isArray(request.params.coupon) ? request.params.coupon[0] : request.params.coupon;
        const cart_id = Array.isArray(request.params.cart_id) ? request.params.cart_id[0] : request.params.cart_id;
