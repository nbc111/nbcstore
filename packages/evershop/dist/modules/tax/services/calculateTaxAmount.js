...
export function calculateTaxAmount(taxPercentage, price, quantity = 1, priceIncludingTax = false) {
    ...
    const taxAmountUnit = priceIncludingTax === false ? price * taxPercentage / 100 : price * taxPercentage / (100 + taxPercentage);
