export default {
    Setting: {
        defaultProductTaxClassId: (setting)=>{
            const defaultProductTaxClassId = setting.find((s)=>s.name === 'defaultProductTaxClassId');
        ...
        defaultShippingTaxClassId: (setting)=>{
            const defaultShippingTaxClassId = setting.find((s)=>s.name === 'defaultShippingTaxClassId');
        ...
        baseCalculationAddress: (setting)=>{
            const baseCalculationAddress = setting.find((s)=>s.name === 'baseCalculationAddress');
